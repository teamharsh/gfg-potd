...
// find height of given node and return to balanceFactor
...
Node* deleteNode(Node* root, int data)
{
    ...
    // finding the value in the avl tree   
    if(root->data<data)
        ...
        int balanceFactorValue = balanceFactor(root);
          ...
          else if(balanceFactorValue<-1 && balanceFactor(root->left)<=0)
                return rightRotation(root);
          else if(balanceFactorValue>1 && balanceFactor(root->right)<0){
